...
initAudio($('#track-list .track').first());
...
function initAudio(element){
  ...
  $('#track-list .track.active li').addClass('active');
    songDuration();
...
$('#track-list .track').click(function(){
  $('#track-list .track.active li').removeClass('active');
  $('div.player-sp').show();
  audio.pause();
  initAudio($(this));
  $('.player-sp').show(400);
...
function songDuration(){
  $(audio).bind('timeupdate',function(){
    ...
    if(value == 100)
    {
      ...
      var next = $('#track-list .track.active').next();
      if(next.length == 0){
        audio.currentTime = 0;
        audio.pause();
        $('.player-sp').hide();
